...
namespace MVC_MovieShop_.Controllers
{
    public class RentalHeadersController : Controller
    {
        ...
        {
            var applicationDbContext = _context.RentalHeaders
                .Include(rh => rh.CustomerDetails)
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewBag.SelectedMovies = rentalHeader.RentalDetails?.Select(d => new { d.MovieId, d.Movie.Title, d.Status, d.RentalFee }).ToList();
            return View(rentalHeader);
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("RentalHeaderId,CustomerId,RentalDate,ReturnDate")] RentalHeader rentalHeader, List<int> MovieIds, List<string> Statuses)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    _context.RentalDetails.RemoveRange(existingRental.RentalDetails);
        ...
        {
            return _context.RentalHeaders.Any(e => e.Id == id);
        }
    }
}
